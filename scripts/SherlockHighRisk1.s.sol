...
/// @notice Scripts to deploy first batch of high risk tickets from the Sherlock audit
///         Proposal 1: Staking + StakingPool + SystemReward: #92 + #121 (will include #120) + #71 + #73, #125 + #56, #134, #3
...
contract Propose is Script {
    function run() public {
        ...
        calldatas[2] = abi.encodeWithSignature(
            ...
            vm.getDeployedCode("SystemReward.sol:SystemReward"),
            ""
        );
