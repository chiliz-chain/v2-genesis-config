...
/// ChainConfigOverride contract used to bypass the local tx simulation issue of foundry.
/// This is basically ChainConfig from v2.3.0 with an empty initEpochParams() function added to it
/// and is used by SherlockHighRisk2.s.sol

contract ChainConfigOverride is InjectorContextHolder {
    ...
    function initEpochParams() public {}
    ...
    function setActiveValidatorsLength(uint32 newValue) external onlyFromGovernance {
    ...
    function setMisdemeanorThreshold(uint32 newValue) external onlyFromGovernance {
    ...
    function setFelonyThreshold(uint32 newValue) external onlyFromGovernance {
    ...
    function setValidatorJailEpochLength(uint32 newValue) external onlyFromGovernance {
    ...
    function setUndelegatePeriod(uint32 newValue) external onlyFromGovernance {
    ...
    function setMinValidatorStakeAmount(uint256 newValue) external onlyFromGovernance {
    ...
    function setMinStakingAmount(uint256 newValue) external onlyFromGovernance {
